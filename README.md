...
## Preamble
- 👩‍🔬 I am a Bioinformatician and Data Science professional interested in developing computational tools and applying statistical methods, and cutting-edge technologies (including machine learning and artificial intelligence) for integrating, managing and analyzing high-dimensional data to unravel true associations and discovery hidden patterns, and unknown correlations in big data.
- 💞️ I am excited by big, complex and messy data that ends up into beautiful and meaningful visualizations that help us derive actionable insights and new hypotheses for informed decisionas and to support the translation of institutional/business requirements into substantial deliverables. 
